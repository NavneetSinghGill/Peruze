...
class RequestsCollectionViewCell: UICollectionViewCell, UIScrollViewDelegate {
    ...
    //your item
    var itemRequestedFromUser: Item? {
        didSet {
        ...
        if confirmCircleView!.frame.contains(sender.locationInView(self)) {
            ...
            UIView.animateWithDuration(Constants.Animation.Duration,
                ...
                animations: {
                    ...
                    self.delegate?.requestAccepted(self.itemRequestedFromUser!, forItem: self.itemOfferedToUser!)
            })
            ...
            UIView.animateWithDuration(Constants.Animation.Duration,
                ...
                animations: {
                    ...
                    view.removeFromSuperview()
                    largeImage.removeFromSuperview()
                    self.delegate?.requestDenied(self.itemRequestedFromUser!, forItem: self.itemOfferedToUser!)
            })
        }
    }
